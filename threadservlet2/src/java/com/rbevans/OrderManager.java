...
public class OrderManager {
    ...
    public final synchronized int cartSize (HttpSession session) {
        return getOrder(session).size();
    }
    
    public final synchronized String getItem(int i, HttpSession session) {
        return getOrder(session).getItem(i);
    }
    
    public final synchronized Order getOrder(HttpSession session) {
    ...
    private final synchronized Order getOrder(int orderNum) {
    ...
    public synchronized void putInCart(String item, HttpSession session) {
