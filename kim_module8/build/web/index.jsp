<%-- 
    Document   : index
    Created on : Oct 27, 2016, 11:59:40 AM
    Author     : justinkim
--%>
...
<html>
    ...
    <center>
        <div id="top">
            <div id="banner">
                <img id="bannerImg" width="800" src="./Beartooth002-01.jpg" />
        ...
        <div id="middle">
            <table border="2">
                ...
                <tr>
                    <td align="center"><img src="./BeartoothIslandLakeTrail_0326_800x600.jpg" alt="image for gardiner lake" width="300" height="150"/><br/>
			...
			<ul>
                ...
                <tr>
                    <td align="center"><img src="./clay_butte_06.jpg" alt="image for hellroaring pateau" width="300" height="150"/><br/>
			...
			<ul>
                ...
                <tr>
                    <td align="center">
			<img src="./BeartoothView_800x600.jpg" alt="image for beaten path" width="300" height="150"/><br/>
			<i><b>Beaten Path</b></i>
                    </td>
                    <td>
			<ul>
        ...
        <div id="bottom">
            <form action="Module8" method=GET>
                <table width="800">
                    <tr height="120">
                    ...
                    <tr>
                        <td>
                            <table width="180">
                                ...
                                <tr>
                                    <td>
                                        <input type="Text" id="date" name="dateInput" maxlength="25" size="19">
