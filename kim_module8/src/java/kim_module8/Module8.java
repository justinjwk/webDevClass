 ...
 * @author Justin
 */
@WebServlet(name = "Module8", urlPatterns = {"/Module8"})
public class Module8 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dateString.length != 3) {
                ...
                out.println("<tr>");
                out.println("<th>");
                out.println("<h2>Error: Date format is not valid!</h2> <br>");
                out.println("</th>");
                out.println("<tr>");
                out.println("<td>");
                out.println("<h3>Date format should be MM-DD-YYYY in numbers</h3> <br>");
            ...
            if(tour.equals("gardiner")) {
                ...
                if(bookingDay.isValidDate() && cost != 0) {
                    ...
                    out.println("<h1>Duration: " + duration + " days</h1><br>");
                    out.println("<h1>Number of People: " + numOfPeople + "</h1><br></td></tr>");
                    out.println("<tr><td colspan=2>");
